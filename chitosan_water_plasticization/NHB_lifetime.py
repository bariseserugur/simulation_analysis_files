...
'''This code analyzes the HB lifetimes for H-bonds involving Nitrogens.
'''
...
#Output File
f_out = open('NHB_lifetimes.out','wb')
...
tau_frames,HB_lifetimes = run_lifetime(u,s_donors,s_hydrogens,pn)
...
tau_frames,HB_lifetimes = run_lifetime(u,pn,p_hydrogens,s_acceptors)
pickle.dump(np.array(HB_lifetimes), f_out)
